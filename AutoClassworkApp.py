...
# Load Dataset
# -------------------------
df = pd.read_csv("jiji_car_dataset.csv")  # Replace with your dataset path
...
# Convert year to int and remove invalid years
...
# 3️⃣ Price Distribution by Condition (Boxplot)
...
# 4️⃣ Distribution of Car Years (Histogram)
...
# 7️⃣ Top 3 Models per Brand Table
